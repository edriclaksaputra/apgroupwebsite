      ...
      <div class="container inner">
        ...
        <div class="row">
          ...
          <div class="col-sm-5" style="padding-right: 0px">
              ...
              <p>E: info@ap-grp.com</p>

              <p style="margin-bottom: -8px; font-size: 20px"><strong>BEIJING (CHINA HEADQUARTER)</strong></p>
            ...
            <div>
              ...
              <p style="margin-bottom: -8px; font-size: 20px"><strong>CEBU (BRANCH OFFICE)</strong></p>
              <p style="margin-bottom: -8px">Unit 821, Lot 8 Building, P Almendas Ext.,</p>
              <p style="margin-bottom: -8px">Cebu, Philippines 6000</p>
              <p>T: +63 32 260 6918 E: ap-cebu@ap-grp.com</p>
              
              <p style="margin-bottom: -8px; font-size: 20px"><strong>SHANGHAI (BRANCH OFFICE)</strong></p>
              <p style="margin-bottom: -8px">2302, Ocean Plaza, 1188 Siping Road, Shanghai</p>
              <p style="margin-bottom: -8px">200092</p>
              <p>T: 021 - 6579 7261 E: ap-sh@ap-grp.com</p>
              
              <p style="margin-bottom: -8px; font-size: 20px"><strong>BANGKOK (ID STUDIO)</strong></p>
              <p style="margin-bottom: -8px">290/300 Baanklang Praditmanut Rd.,</p>
              <p style="margin-bottom: -8px">Bangkok, Thailand 10310</p>
              <p>E: ap-bkk@ap-grp.com</p>
              
              <p style="margin-bottom: -8px; font-size: 20px"><strong>SUZHOU (BRANCH OFFICE)</strong></p>
              <p style="margin-bottom: -8px">803, Building B Huihi Building No 10, Yuewan Road,</p>
              <p style="margin-bottom: -8px">Suzhou 215123</p>
              <p>T: 0512 - 6276 1650 E: ap-sz@ap-grp.com</p>
              
              <p style="margin-bottom: -8px; font-size: 20px"><strong>NANJING (REPRESENTATIVE OFFICE)</strong></p>
              <p style="margin-bottom: -8px">9th Floor, Jinji Plaza, No 270 Shuximen Road,</p>
              <p style="margin-bottom: -8px">Nanjing 210002</p>
              <p>T: 025 - 833 279 39 E: ap-nj@ap-grp.com</p>
            </div>
          </div>
