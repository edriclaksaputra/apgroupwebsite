        ...
        <div id="js-grid-mosaic" class="cbp">
            ...
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-alignCenter">
                <div class="cbp-l-caption-body">
                  <div class="cbp-l-caption-title">101 Hotel Cebu</div>
                </div>
              </div>
            </div>
            <li class="item">
              <div class="slide-portfolio-item-info box">
                <h4 class="post-title" style="text-align: center">Title Example Title</h4>
              </div>
            </li>
          ...
          <div class="cbp-item hospitality"> <a class="cbp-caption" href="projectdetail">
            ...
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-alignCenter">
                <div class="cbp-l-caption-body">
                  <div class="cbp-l-caption-title">Camotes Resort</div>
                </div>
              </div>
            </div>
            <!--/.cbp-caption-activeWrap --> 
          ...
          <div class="cbp-item hospitality"> <a class="cbp-caption" href="projectdetail">
            ...
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-alignCenter">
                <div class="cbp-l-caption-body">
                  <div class="cbp-l-caption-title">Martin Avenue</div>
                </div>
              </div>
            </div>
            <!--/.cbp-caption-activeWrap --> 
          ...
          <div class="cbp-item hospitality"> <a class="cbp-caption" href="projectdetail">
            ...
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-alignCenter">
                <div class="cbp-l-caption-body">
                  <div class="cbp-l-caption-title">Pan Pacific</div>
                </div>
              </div>
            </div>
            <!--/.cbp-caption-activeWrap --> 
          ...
          <div class="cbp-item hospitality"> <a class="cbp-caption" href="projectdetail">
            ...
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-alignCenter">
                <div class="cbp-l-caption-body">
                  <div class="cbp-l-caption-title">Shangrila Jiangsu</div>
                </div>
              </div>
            </div>
            <!--/.cbp-caption-activeWrap --> 
          ...
          <div class="cbp-item residential hospitality"> <a class="cbp-caption" href="projectdetail">
            ...
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-alignCenter">
                <div class="cbp-l-caption-body">
                  <div class="cbp-l-caption-title">TAG Metro Manila</div>
                </div>
              </div>
            </div>
            <!--/.cbp-caption-activeWrap --> 
          ...
          <div class="cbp-item industrial"> <a class="cbp-caption" href="projectdetail">
            ...
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-alignCenter">
                <div class="cbp-l-caption-body">
                  <div class="cbp-l-caption-title">DEFU Industrial City</div>
                </div>
              </div>
            </div>
            <!--/.cbp-caption-activeWrap --> 
          ...
          <div class="cbp-item industrial"> <a class="cbp-caption" href="projectdetail">
            ...
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-alignCenter">
                <div class="cbp-l-caption-body">
                  <div class="cbp-l-caption-title">HG Metal</div>
                </div>
              </div>
            </div>
            <!--/.cbp-caption-activeWrap --> 
          ...
          <div class="cbp-item industrial"> <a class="cbp-caption" href="projectdetail">
            ...
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-alignCenter">
                <div class="cbp-l-caption-body">
                  <div class="cbp-l-caption-title">SECOM Building</div>
                </div>
              </div>
            </div>
            <!--/.cbp-caption-activeWrap --> 
          ...
          <div class="cbp-item industrial"> <a class="cbp-caption" href="projectdetail">
            ...
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-alignCenter">
                <div class="cbp-l-caption-body">
                  <div class="cbp-l-caption-title">Wajiawan Transport Hub</div>
                </div>
              </div>
            </div>
            <!--/.cbp-caption-activeWrap --> 
          ...
          <div class="cbp-item institutional"> <a class="cbp-caption" href="projectdetail">
            ...
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-alignCenter">
                <div class="cbp-l-caption-body">
                  <div class="cbp-l-caption-title">Meikarta University</div>
                </div>
              </div>
            </div>
            <!--/.cbp-caption-activeWrap --> 
          ...
          <div class="cbp-item institutional"> <a class="cbp-caption" href="projectdetail">
            ...
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-alignCenter">
                <div class="cbp-l-caption-body">
                  <div class="cbp-l-caption-title">Myanmar Engineering Council</div>
                </div>
              </div>
            </div>
            <!--/.cbp-caption-activeWrap -->
          ...
          <div class="cbp-item institutional"> <a class="cbp-caption" href="projectdetail">
            ...
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-alignCenter">
                <div class="cbp-l-caption-body">
                  <div class="cbp-l-caption-title">Tamwe General Hospital</div>
                </div>
              </div>
            </div>
            <!--/.cbp-caption-activeWrap --> 
          ...
          <div class="cbp-item institutional"> <a class="cbp-caption" href="projectdetail">
            ...
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-alignCenter">
                <div class="cbp-l-caption-body">
                  <div class="cbp-l-caption-title">Wuhan Metallurgical HQ</div>
                </div>
              </div>
            </div>
            <!--/.cbp-caption-activeWrap --> 
          ...
          <div class="cbp-item residential"> <a class="cbp-caption" href="projectdetail">
            ...
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-alignCenter">
                <div class="cbp-l-caption-body">
                  <div class="cbp-l-caption-title">BBB Residences</div>
                </div>
              </div>
            </div>
            <!--/.cbp-caption-activeWrap --> 
          ...
          <div class="cbp-item residential"> <a class="cbp-caption" href="projectdetail">
            ...
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-alignCenter">
                <div class="cbp-l-caption-body">
                  <div class="cbp-l-caption-title">Bonamy Tower</div>
                </div>
              </div>
            </div>
            <!--/.cbp-caption-activeWrap --> 
          ...
          <div class="cbp-item residential"> <a class="cbp-caption" href="projectdetail">
            ...
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-alignCenter">
                <div class="cbp-l-caption-body">
                  <div class="cbp-l-caption-title">Greenland Wujiang Lake</div>
                </div>
              </div>
            </div>
            <!--/.cbp-caption-activeWrap --> 
          ...
          <div class="cbp-item residential"> <a class="cbp-caption" href="projectdetail">
            ...
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-alignCenter">
                <div class="cbp-l-caption-body">
                  <div class="cbp-l-caption-title">M-Green Residences</div>
                </div>
              </div>
            </div>
            <!--/.cbp-caption-activeWrap --> 
          ...
          <div class="cbp-item residential"> <a class="cbp-caption" href="projectdetail">
            ...
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-alignCenter">
                <div class="cbp-l-caption-body">
                  <div class="cbp-l-caption-title">SIY Mixed Use Complex</div>
                </div>
              </div>
            </div>
            <!--/.cbp-caption-activeWrap --> 
          ...
          <div class="cbp-item residential"> <a class="cbp-caption" href="projectdetail">
            ...
            <div class="cbp-caption-activeWrap">
              <div class="cbp-l-caption-alignCenter">
                <div class="cbp-l-caption-body">
                  <div class="cbp-l-caption-title">Wuhu City Complex</div>
                </div>
              </div>
            </div>
            <!--/.cbp-caption-activeWrap --> 
